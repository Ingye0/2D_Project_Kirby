...
public class CameraController : MonoBehaviour
{
    ...
    [Header("참조")]
    [SerializeField] private Transform target;                  // 커비 캐릭터
    [SerializeField] private SpriteRenderer foreGroundRenderer; // 맵의 SpriteRenderer

    [Header("경계 보정")]
    [SerializeField] private float borderPadding = 0.1f;
    ...
    void LateUpdate()
    {
        ...
        if (shakeDuration > 0)
        {
            ...
            constantShakeTimer += Time.deltaTime * 50f; // 떨림 속도 제어
